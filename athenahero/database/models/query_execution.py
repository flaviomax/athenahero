...
class QueryExecution(db.Model):
    ...
    query_text = db.Column(db.Text, index=False, unique=False, nullable=False)
    statement_type = db.Column(db.String(10), index=False, unique=False, nullable=False)
    output_location = db.Column(db.Text, index=False, unique=False, nullable=False)
    encryption_option = db.Column(db.String(10), index=False, unique=False, nullable=True)
    kms_key = db.Column(db.Text, index=False, unique=False, nullable=True)
    context_database = db.Column(db.Text, index=False, unique=False, nullable=True)
    context_catalog = db.Column(db.Text, index=False, unique=False, nullable=True)
    ...
    query_planning_time_in_millis = db.Column(db.Integer, index=False, unique=False, nullable=True)
